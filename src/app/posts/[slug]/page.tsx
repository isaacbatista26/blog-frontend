  ...
  return (
    <div>
            ...
            return (
              <div key={tag} className="p-5 my-auto">
                <div className="py-2 px-6 border-solid border-black rounded-3xl border-2">
                  <h2 className="text-[10px] text-[#5C5C5C] text-center">{tag}</h2>
                </div>
              </div>
            );
          })
      ...
      <div className="flex justify-center m-3">
        <section className="p-5 my-auto">por <strong>Nome do Autor</strong></section>
        <section className="p-5 my-auto">Último update: {dateFormat(post.createdAt)}</section>
      </div>

      <div className="flex justify-center mx-auto my-3">
        <div className="p-1 my-auto"><WhatsappIcon/></div>
        <div className="p-1 my-auto"><ShareIcon/></div>
        <div className="p-1 my-auto"><InstaIcon/></div>
      </div>
