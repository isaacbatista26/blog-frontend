                    ...
                    <div className="flex items-center justify-between h-16">
                            ...
                            <div className="hidden lg:flex gap-11">
                                <div className="ml-4 flex items-center gap-11">
                                    <Link href="#" className="text-white hover:text-stone-600 p-2"><p>Sobre nós</p></Link>
                                    <Link href="#" className="text-white hover:text-stone-600 p-2"><p>Contato</p></Link>
                                    <Link href="#" className="text-white hover:text-stone-600 p-2"><p>Publicações</p></Link>
                                </div>
                                
                                <div className="flex items-center gap-11">
                                    <button className="rounded-full py-2 px-4 bg-gradient-to-r from-[#1C2337] to-[#5C86F2]">
                                        <p className="text-white hover:text-stone-300">Mapa de Calor</p>
                                    </button>
                                    <button>
                                        <Image
