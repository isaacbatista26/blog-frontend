...
export default function ReverseScroll() {
  return (
    ...
    <div className="w-full inline-flex flex-nowrap group overflow-x-hidden">
      <ul className="flex items-center justify-center py-3  md:justify-start [&_li]:mx-8 [&_img]:max-w-none animate-infinite-scroll-reverse group-hover:paused">
      ...
      <ul
        className="flex items-center justify-center py-3 md:justify-start [&_li]:mx-8 [&_img]:max-w-none animate-infinite-scroll-reverse group-hover:paused"
        aria-hidden="true"
      >
        <li className="transform-gpu transition-transform hover:scale-110 max-w-xs">
          <img src="/home/participantes/Ellipse1.png" alt="Facebook" />
